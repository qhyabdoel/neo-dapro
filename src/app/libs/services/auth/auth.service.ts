...
import { Permission, QueryParamsModel, QueryResultsModel, Role, User } from 'src/app/libs/models';
...
export class AuthService {
  ...
  login(userCredential: UserCredential): Observable<any> {
    return this.http.post<any>(rest_api.AUTH_LOGIN, userCredential);
  }

  logout(authToken: string): Observable<any> {
    return this.http.post(rest_api.AUTH_LOGOUT, {}, {
  ...
  refreshToken(): Observable<any> {
    return this.http.post<any>(rest_api.REFRESH_TOKEN, {});
  }
