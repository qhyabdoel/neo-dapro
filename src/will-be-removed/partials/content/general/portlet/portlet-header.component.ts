...
import { KtDialogService } from "src/app/libs/services";
import { StickyDirective } from "src/app/libs/directives";
...
@Component({
	...
	template: `
		<div class="kt-portlet__head-label" [hidden]="noTitle">
			...
			<h3 *ngIf="title" class="kt-portlet__head-title text-light" [innerHTML]="title"></h3>
		</div>
