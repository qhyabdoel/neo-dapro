    ...
    ($.AdminPaques.leftSideBar = {
        ...
        checkStatuForResize: function (e) {
            ...
            e &&
                ...
                t < 1170 ? (767 < t && a.addClass(""), a.addClass(""), r.fadeIn()) : (a.removeClass(""), r.fadeOut());
        },
        isOpen: function () {
            return $("body").hasClass("overlay-open");
        },
    }),
    ($.AdminPaques.rightSideBar = {
        activate: function () {
            var r = this,
                t = $("#rightsidebar"),
                i = $(".overlay");
...
($.AdminPaques.browser = {
    ...
    $(function () {
        $.AdminPaques.browser.activate(),
            $.AdminPaques.leftSideBar.activate(),
            $.AdminPaques.rightSideBar.activate(),
            $.AdminPaques.navbar.activate(),
            $.AdminPaques.select.activate(),
            setTimeout(function () {
