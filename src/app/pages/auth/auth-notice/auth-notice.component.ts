...
import { AuthNotice } from 'src/app/libs/services/auth/auth-notice/auth-notice.interface';
import { AuthNoticeService } from "src/app/libs/services";

@Component({
	selector: 'pq-auth-notice',
