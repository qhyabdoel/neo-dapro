...
d3.box2 = function() {
    ...
    g.each(function(data, i) {
	 ...
	 //vertical line
      center.enter().insert("line", "rect")
          .attr("class", "center")
          .attr("x1", width.bandwidth() / 2)
          .attr("y1", function(d) { return x0(d[0]); })
          .attr("x2", width.bandwidth() / 2)
      ...
      // Update box ticks.
      var boxTick = g.selectAll("text.box2")
          .data(quartileData);
	 if(showLabels == true) {
      boxTick.enter().append("text")
          ...
          .attr("x", function(d, i) { return i & 1 ?  + width.bandwidth() : 0 })
          .attr("y", x0)
  ...
  box2.width = function(x) {
    if (!arguments.length) return width.bandwidth();
    width = x;
    return box2;
  };
